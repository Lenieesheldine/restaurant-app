...
export default function Login({ navigation }){
  ...
  return(
    ...
    <Text style={{textAlign:'center',color:'#B25068',fontWeight:'900',fontSize:40,}}>LOG IN</Text>
<View>
...
<Text style={{textAlign:'center',height:31,color:'#B25068'}}>Forgot Password</Text>

<Text style={{textAlign:'center',fontSize:10}}>Don't have an account?</Text>

<Text style={{textAlign:'center',height:31,color:'#B25068',}}>SIGN UP</Text>

<TouchableOpacity style={styles.btn} onPress={nextpage}>
<Text style={{color:'#fff', fontsize:16, fontWeight:'500'}}>LOG IN</Text>
</TouchableOpacity>
